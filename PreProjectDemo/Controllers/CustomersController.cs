...
public class CustomersController : Controller
{
    ...
    public CustomersController(PreProjectDemoContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([Bind("Id,Name,Age,Email,Phone,IsMarried,Gender")] Customer customer)
    {
